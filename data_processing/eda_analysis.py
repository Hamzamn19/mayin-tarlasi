...
CSV  = BASE / "outputs" / "landmine_tabular_dataV3.csv"
...
plt.tight_layout()
out = BASE / "outputs" / "plots" / "correlation_heatmap.png"
...
plt.tight_layout()
out = BASE / "outputs" / "plots" / "outliers_distributions.png"
fig.savefig(out, dpi=150, bbox_inches="tight")
plt.close(fig)
print(f"  Saved → {out}")
...
plt.tight_layout()
out = BASE / "outputs" / "plots" / "feature_distributions.png"
fig.savefig(out, dpi=150, bbox_inches="tight")
plt.close(fig)
print(f"  Saved → {out}")
